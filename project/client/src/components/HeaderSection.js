      ...
      <header className="w-full bg-secondary py-4 mt-14">
         <div className="header_container flex flex-col justify-center items-center w-11/12 mx-auto ">
             ...
             <div className="header_description flex flex-col text-center">
                 <h1 className="text-2xl mb-1 text-white">Free Resources for Developers</h1>
                 <p className="text-md mb-4 text-white"> This is  a great place to start exploring  resources that are free to use.</p>
